    ...
    internal class Program
    {
        ...
        class Person
        {
            ...
            public void SaveToTxt()
            {
                ...
                string filePath = "C:\\Users\\obiwa\\OneDrive\\Dokumenty\\PROGRAMKO_2324\\prg_Mikula\\Files\\" + Name + ".txt";
            ...
            public static Person LoadFromTxt()
            {
                ...
                string name = Console.ReadLine();
                Console.WriteLine("\n");
                if (File.Exists("C:\\Users\\obiwa\\OneDrive\\Dokumenty\\PROGRAMKO_2324\\prg_Mikula\\Files\\" + name + ".txt"))
                {
                    string txtSaved = File.ReadAllText("C:\\Users\\obiwa\\OneDrive\\Dokumenty\\PROGRAMKO_2324\\prg_Mikula\\Files\\" + name + ".txt");
                    Console.WriteLine(txtSaved + "\n");
                }
