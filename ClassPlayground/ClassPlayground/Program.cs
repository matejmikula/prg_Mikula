...
namespace ClassPlayground
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Its a wide rectangle with the aspect ratio of {CalcAspectRatio}");
            }
            else if ( CalcAspectRatio < 1 ) 
            {
                Console.WriteLine($"Its a high rectangle with the aspect ratio of {CalcAspectRatio}");
            }
            else
            {
