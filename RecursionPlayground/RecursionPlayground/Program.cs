...
namespace RecursionPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int fibonacci = retard(n); // Prvni zavolani pro vypocet Fibonacciho posloupnosti, ulozeni do promenne fibonacci.
        ...
        static int retard(int n)
        {
            ...
            int nFibonacci = retard(n-1) + retard(n-2);
            return nFibonacci;
